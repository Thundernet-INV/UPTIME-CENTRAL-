#!/bin/bash
# fix-energia-detail-consumo.sh
# MODIFICA ENERGIA DETAIL PARA MOSTRAR CONSUMO
...
echo ""
echo "[1] Contenido actual del archivo (primeras líneas):"
head -20 "$DETAIL_FILE"
...
# ========== 3. AGREGAR CONSUMO AL ARCHIVO ==========
echo ""
echo "[3] Agregando sección de consumo..."
...
echo "✅ Sección de consumo agregada"

# ========== 4. AGREGAR ACTUALIZACIÓN EN TIEMPO REAL ==========
echo ""
echo "[4] Agregando actualización en tiempo real..."

# Agregar estado de consumo
sed -i '/const \[.*, set.*\] = useState(/a \  const [consumo, setConsumo] = useState({ sesionActual: 0, historico: 0 });' "$DETAIL_FILE"

# Agregar useEffect para actualizar consumo
...
# ========== 5. REEMPLAZAR VALORES ESTÁTICOS ==========
echo ""
