...
# historyEngine con:
# - fuente principal: memoria (rápido para graficar)
# - IndexedDB en background
# - mkPoint con alias {x,y,value,sec,ms,avgMs,xy}
# - try/catch + return [] SIEMPRE (nunca undefined)
# - logs con tamaños
cat > "$HIST" <<'JS'
...
echo "✓ History: retornos seguros + logs; __hist disponible en consola."
