#!/bin/bash
# fix-syntax-error-ahora.sh - CORREGIR ERROR DE SINTAXIS EN MULTISERVICEVIEW E INSTANCEDETAIL

echo "====================================================="
echo "🔧 CORRIGIENDO ERROR DE SINTAXIS - RANGO.HOURS"
echo "====================================================="

FRONTEND_DIR="/home/thunder/kuma-dashboard-clean/kuma-ui"
BACKUP_DIR="${FRONTEND_DIR}/backup_syntax_fix_$(date +%Y%m%d_%H%M%S)"
...
echo "[2] Corrigiendo InstanceDetail.jsx - ELIMINAR range.hours del estado..."
...
// Opciones de tiempo (respaldo por si no hay useTimeRange)
const TIME_OPTIONS = [
  ...
  return (
    <div className="instance-detail-page">
      <div className="instance-detail-header">
        ...
        <div style={{ marginLeft: 'auto', fontSize: '0.85rem', color: 'var(--text-secondary, #6b7280)' }}>
          📊 {rangeLabel}
        </div>
      </div>
...
echo "[3] Corrigiendo MultiServiceView.jsx - ELIMINAR range.hours del estado..."
...
echo ""
echo "   1. 🚫 ELIMINADO: const [range.hours, setSelectedHours] - ¡ESO NO SE PUEDE!"
echo "   2. ✅ AHORA USAMOS: const range = useTimeRange()"
echo "   3. ✅ LUEGO: range.hours (accedemos a la propiedad del objeto)"
echo ""
echo "🔄 PRUEBA AHORA:"
echo ""
echo "   1. Abre http://10.10.31.31:5173"
echo "   2. ✅ EL DASHBOARD DEBE CARGAR SIN ERRORES"
echo "   3. ✅ El selector de tiempo debe funcionar"
echo ""
echo "====================================================="
