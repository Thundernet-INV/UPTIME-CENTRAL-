#!/bin/bash
# fix-estado-plantas.sh
# CORRIGE EL ESTADO DE LAS PLANTAS CONSULTANDO LA INSTANCIA ENERGIA

echo "====================================================="
echo "🔧 CORRIGIENDO ESTADO DE PLANTAS"
echo "====================================================="
...
echo ""
echo "[2] Corrigiendo AdminPlantas.jsx para mostrar estado real..."
...
export default function AdminPlantas() {
  ...
  const cargarEstadosReales = async () => {
    try {
      ...
      // Filtrar monitores de la instancia Energia
      const monitoresEnergia = data.monitors.filter(m => m.instance === 'Energia');
      
      // Crear mapa de estados
      const estados = {};
      monitoresEnergia.forEach(m => {
        estados[m.info.monitor_name] = {
  ...
  // Verificar cuántas plantas están UP
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', gap: 12 }}>
          ...
          <span className="estadistica" style={{ 
            ...
            🔴 Apagadas: {plantas.length - plantasUp}
          </span>
        </div>
      </div>
...
echo "✅ AdminPlantas.jsx corregido"
...
echo ""
echo "====================================================="
echo "✅✅ ESTADO DE PLANTAS CORREGIDO ✅✅"
echo "====================================================="
echo ""
echo "📊 Ahora deberías ver el estado REAL de las plantas:"
echo "   • PLANTA ELECTRICA CABUDARE: 🟢 ENCENDIDA"
echo "   • Las demás: según su estado real"
echo "   • Latencia y último check en tiempo real"
echo ""
