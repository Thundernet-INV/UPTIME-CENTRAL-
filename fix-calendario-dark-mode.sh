#!/bin/bash
# fix-calendario-dark-mode.sh - CALENDARIO SIN FONDO EN MODO OSCURO

echo "====================================================="
echo "🌙 ACTUALIZANDO CALENDARIO - SIN FONDO EN MODO OSCURO"
echo "====================================================="

FRONTEND_DIR="/home/thunder/kuma-dashboard-clean/kuma-ui"
BACKUP_DIR="${FRONTEND_DIR}/backup_calendario_dark_$(date +%Y%m%d_%H%M%S)"
...
echo "[2] Actualizando dark-mode.css - calendario sin fondo..."

cat >> "${FRONTEND_DIR}/src/dark-mode.css" << 'EOF'

/* ========== CALENDARIO - MODO OSCURO SIN FONDO ========== */
body.dark-mode .time-range-selector div[style*="border-radius: 10px"][style*="background: rgb(249, 250, 251)"] {
...
body.dark-mode .time-range-selector button[style*="background: transparent"] {
  color: #e5e7eb !important;
}

body.dark-mode .time-range-selector button[style*="background: transparent"]:hover {
  background: #374151 !important;
}

/* Días del calendario */
body.dark-mode .time-range-selector div[style*="grid-template-columns: repeat(7, 1fr)"] button {
  background: transparent !important;
  color: #e5e7eb !important;
  border: none !important;
}

body.dark-mode .time-range-selector div[style*="grid-template-columns: repeat(7, 1fr)"] button:hover {
  background: #374151 !important;
}
...
/* Días de la semana */
body.dark-mode .time-range-selector div[style*="color: rgb(107, 114, 128)"] span {
  color: #9ca3af !important;
}

/* Mes y año */
body.dark-mode .time-range-selector span[style*="font-weight: 600"] {
  color: #e5e7eb !important;
}
EOF

echo "✅ dark-mode.css actualizado - calendario sin fondo"
echo ""

# ========== 3. ACTUALIZAR TIMERANGESELECTOR.JSX - ASEGURAR QUE EL CALENDARIO TENGA BACKGROUND SOLO EN MODO CLARO ==========
echo "[3] Asegurando que el calendario tenga background solo en modo claro..."

cat > "${FRONTEND_DIR}/src/components/TimeRangeSelector.jsx" << 'EOF'
// src/components/TimeRangeSelector.jsx - CON CALENDARIO Y BACKGROUND SOLO EN MODO CLARO
      ...
      {isOpen && (
        <div style={{
          ...
          {!showAbsolute ? (
            ...
            /* VISTA DE RANGO ABSOLUTO CON CALENDARIO - BACKGROUND SOLO EN MODO CLARO */
            <div style={{ padding: '20px', overflow: 'auto', maxHeight: '500px' }}>
              ...
              {/* 🟢 CALENDARIO - SIN BACKGROUND EN MODO OSCURO */}
              <div style={{ 
                padding: '16px',
                background: isDark ? 'transparent' : '#f9fafb',  // ← SIN FONDO EN MODO OSCURO
                borderRadius: '10px',
                marginBottom: '20px',
                border: `1px solid ${isDark ? '#374151' : '#e5e7eb'}`
              }}>
...
echo "✅ TimeRangeSelector.jsx actualizado - calendario sin fondo en modo oscuro"
echo ""
...
echo ""
echo "====================================================="
echo "✅✅ CALENDARIO ACTUALIZADO - SIN FONDO EN MODO OSCURO ✅✅"
echo "====================================================="
echo ""
echo "🌙 MODO OSCURO:"
echo "   • Calendario: SIN FONDO (transparente)"
echo "   • Borde: #374151"
echo "   • Texto: #e5e7eb"
echo "   • Hover: #374151"
echo ""
echo "☀️ MODO CLARO:"
echo "   • Calendario: Fondo #f9fafb"
echo "   • Borde: #e5e7eb"
echo ""
echo "🔄 PRUEBA AHORA:"
echo ""
...
echo "   4. ✅ CAMBIA entre modo claro/oscuro"
echo "   5. ✅ En modo oscuro, el calendario NO tiene fondo"
echo ""
echo "====================================================="
