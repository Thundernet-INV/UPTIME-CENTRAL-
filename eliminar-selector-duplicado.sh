#!/bin/bash
# eliminar-selector-duplicado.sh - ELIMINA EL SELECTOR DE RANGO DUPLICADO

echo "====================================================="
echo "🗑️  ELIMINANDO SELECTOR DE RANGO DUPLICADO"
echo "====================================================="

FRONTEND_DIR="/home/thunder/kuma-dashboard-clean/kuma-ui"
BACKUP_DIR="${FRONTEND_DIR}/backup_eliminar_duplicado_$(date +%Y%m%d_%H%M%S)"
...
# ========== 2. ELIMINAR EL SELECTOR DUPLICADO ==========
echo "[2] Eliminando selector duplicado del archivo..."

# Crear archivo temporal sin el bloque duplicado
cat > "${FRONTEND_DIR}/src/components/TimeRangeSelector.jsx" << 'EOF'
// src/components/TimeRangeSelector.jsx - VERSIÓN LIMPIA SIN DUPLICADOS
        ...
        <div style={{
          ...
          {!showAbsolute ? (
            ...
            <div style={{ padding: '20px', overflow: 'auto', maxHeight: '500px' }}>
              ...
              {/* CALENDARIO - SIN SELECTOR DUPLICADO */}
              <div style={{ 
                padding: '16px',
...
echo "✅ Selector duplicado eliminado"
echo ""
...
echo ""
echo "   1. 🗑️  ELIMINADO el selector duplicado que mostraba:"
echo "      • 🔵 SELECCIONANDO DESDE"
echo "      • ⇄ Intercambiar fechas"
echo "      • ✓ HASTA con botón 'Ahora'"
echo ""
echo "   2. ✅ CONSERVADO el calendario funcional"
echo "   3. ✅ CONSERVADOS los inputs Desde/Hasta"
echo "   4. ✅ CONSERVADO el botón 'Aplicar rango de tiempo'"
echo ""
echo "🔄 PRUEBA AHORA:"
echo ""
...
echo "   4. ✅ El selector duplicado YA NO APARECE"
echo "   5. ✅ El calendario sigue funcionando"
echo ""
echo "====================================================="
